            ...
            OCA.Files.fileActions.registerAction({
                ...
                actionHandler: function (filename, context) {
                    ...
                    $('#linkeditor').append(
                        ...
                        + '<p>' + t('video_converter', 'Note: This could take a considerable amount of time depending on your hardware and the preset you chose. You can safely close this window.') + '</p>'
                        + '</div>'
                        + '<div id="params">'
                        + '<p class="vc-label urldisplay" id="labelPreset" style="display:inline-block; margin-right:5px;">'
                        + t('video_converter', 'Preset')
                        + '</p>'
                        + '<select id="preset">'
                        ...
                        + '<option value="medium" selected>Medium (' + t('video_converter', 'default') + ')</option>'
                        + '<option value="slow">Slow</option>'
                        + '<option value="slower">Slower</option>'
                        + '<option value="veryslow">VerySlow</option>'
                        + '</select>'
                        + '<br>'
                        + '<p id="note">' + t('video_converter', 'Note: faster means worse quality or bigger size.') + '</p>'
                        + '<br>'
                        + '<p class="vc-label urldisplay" id="labelPriority" style="display:inline-block; margin-right:5px;">'
                        + t('video_converter', 'Priority')
                        + '</p>'
                        + '<select id="priority" style="margin-bottom: 10px;">'
                        + '<option value="-10">' + t('video_converter', 'High') + '</option>'
                        + '<option value="0">' + t('video_converter', 'Normal') + ' (' + t('video_converter', 'default') + ')</option>'
                        + '<option value="10" selected>' + t('video_converter', 'Low') +'</option>'
                        + '</select>'
                        + '<br>'
                        + '<p class="vc-label urldisplay" id="labelCodec" style="display:inline-block; margin-right:5px;">'
                        + t('video_converter', 'Codec')
                        + '</p>'
                        + '<select id="vcodec" style="margin-bottom: 10px;">'
                        + '<option value="none">' + t('video_converter', 'Auto') + '</option>'
                        ...
                        + t('video_converter', 'Target bitrate')
                        + '</p>'
                        + '<select id="vbitrate" style="margin-bottom: 10px;">'
                        + '<option value="none">' + t('video_converter', 'Auto') + '</option>'
                        + '<option value="1">1 ' + t('video_converter', 'Mbit') + '</option>'
                        + '<option value="2">2 ' + t('video_converter', 'Mbit') + '</option>'
                        + '<option value="3">3 ' + t('video_converter', 'Mbit') + '</option>'
                        + '<option value="4">4 ' + t('video_converter', 'Mbit') + '</option>'
                        + '<option value="5">5 ' + t('video_converter', 'Mbit') + '</option>'
                        + '<option value="6">6 ' + t('video_converter', 'Mbit') + '</option>'
                        + '<option value="7">7 ' + t('video_converter', 'Mbit') + '</option>'
                        + '</select>'
                        + '<p class="vc-label urldisplay" id="labelBitrateUnit" style="display:inline-block; margin-right:5px;">'
                        + t('video_converter', 'Mbit/s')
                        + '</p>'
                        + '<br>'
                        + '<p class="vc-label urldisplay" id="labelScale" style="display:inline-block; margin-right:5px;">'
                        + t('video_converter', 'Scale to')
                        + '</p>'
                        + '<select id="scale" style="margin-bottom: 10px;">'
                        + '<option value="none">' + t('video_converter', 'Keep') + '</option>'
                        ...
                        + '<option value="320">' + t('video_converter', 'Keep aspect') +' 320 (Wx320)</option>'
                        + '<option value="480">' + t('video_converter', 'Keep aspect') +' 480 (Wx480)</option>'
                        + '<option value="600">' + t('video_converter', 'Keep aspect') +' 600 (Wx600)</option>'
                        + '<option value="720">' + t('video_converter', 'Keep aspect') +' 720 (Wx720)</option>'
                        + '<option value="1080">' + t('video_converter', 'Keep aspect') + ' 1080 (Wx1080)</option>'
                        + '</select><br>'
                        + '<div class="checkbox-container">'
                        + '<label class="vc-label" for="movflags">' + t('video_converter', 'Use faststart (for MP4)') + '</label>'
