            ...
            OCA.Files.fileActions.registerAction({
                ...
                actionHandler: function (filename, context) {
                    ...
                    $('#linkeditor').append(
                        ...
                        + '<br>'
                        + '<p class="urldisplay" id="labelPriority" style="display:inline-block; margin-right:5px;">'
                        + 'Priority'
                        + '</p>'
                        ...
                        + '</select>'
                        + '<br>'
                        + '<p class="urldisplay" id="labelCodec" style="display:inline-block; margin-right:5px;">'
                        + 'Codec'
                        + '</p>'
                        ...
                        + '</select>'
                        + '<p class="urldisplay" id="labelBitrate" style="display:inline-block; margin-right:5px;">'
                        + 'Target bitrate'
                        + '</p>'
                        ...
                        + '</select>'
                        + '<p class="urldisplay" id="labelBitrateUnit" style="display:inline-block; margin-right:5px;">'
                        + 'kbit/s'
                        + '</p>'
                        + '<br>'
                        + '<p class="urldisplay" id="labelScale" style="display:inline-block; margin-right:5px;">'
                        + 'Scale to'
                        + '</p>'
                        ...
                        + '<label for="movflags">Faststart option (for MP4)</label>'
